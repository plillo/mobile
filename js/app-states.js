...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider) {
    ...
    */
    ...
    .state('app.microsocial', {
            url: '/microsocial',
            views: {
                'menuContent': {
                    templateUrl: 'templates/micro-social.html'
                }
            }
        })
    ...
    .state('app.consulting', {
        ...
        views: {
            'menuContent': {
                templateUrl: 'templates/micro-consulting.html'
            }
        }
    })
    ...
    .state('app.subscriptions', {
        ...
        .state('app.subscriptions.list', {
            url: '/subscriptions/list',
            views: {
                'inner': {
                    template: '<app-subscriptions-list></app-subscriptions-list>'
                }
            }
        })
        .state('app.subscriptions.invite', {
            url: '/subscriptions/invite',
            views: {
                'inner': {
                    template: '### INVITE ###'
                }
        ...
        .state('app.subscriptions.rules', {
            url: '/subscriptions/rules',
            views: {
                'inner': {
                    template: '### GENERAL RULES ###: impostare come regole specifiche ma con priorità'
                }
            }
        })
        ...
        .state('app.subscriptions.subscription', {
            url: '/subscription/:uuid',
            views: {
                'inner': {
                    templateUrl: 'templates/business/subscriptions/subscription-main.html',
                    controller: function($scope, $stateParams, $timeout, $ionicSideMenuDelegate, ionicMaterialInk) {
    ...
    .state('app.businessmanager', {
        ...
        .state('app.businessmanager.list', {
                ...
                views: {
                    'inner': {
                        template: '<app-owned-businesses-list></app-owned-businesses-list>'
                    }
                }
            })
        ...
        .state('app.businessmanager.business', {
            ...
            .state('app.businessmanager.business.subscribersmanager', {
                ...
                .state('app.businessmanager.business.subscribersmanager.create', {
                    ...
                    views: {
                        'subscribers-inner': {
                            templateUrl: 'templates/business/subscribers/add-subscribers.html'
                        }
                    }
                })
                .state('app.businessmanager.business.subscribersmanager.list', {
                    ...
                    views: {
                        'subscribers-inner': {
                            templateUrl: 'templates/business/subscribers/list-subscribers.html'
                        }
                    }
                })
